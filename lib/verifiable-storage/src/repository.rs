...
/// different backends (PostgreSQL, etc.) to implement
    ...
    T: SelfAddressed + Serialize + DeserializeOwned + Clone + Send + Sync,
{
    ...
    async fn exists(&self, said: &cesr::Digest256) -> Result<bool, StorageError>;
}
